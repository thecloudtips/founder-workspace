...
description: "Injects relevant memories from the local SQLite memory store into plugin execution context. Use this skill as Step 0 of every plugin command, immediately after business context loading and before main plugin logic, to enrich output with learned preferences, facts, and patterns."
---
