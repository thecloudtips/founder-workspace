...
1. Read `skills/social/template-engine/SKILL.md` — template selection, combination, ranking
2. Read `skills/social/platform-adaptation/SKILL.md` — per-platform rules
3. Read `../../../.founderOS/infrastructure/humanize-content/SKILL.md`
4. Read `../../../.founderOS/infrastructure/humanize-content/references/social-humanization.md`
...
2. Read `skills/social/templates/_performance.yaml`
...
1. Read selected template `.md` files from `skills/social/templates/{name}.md`
