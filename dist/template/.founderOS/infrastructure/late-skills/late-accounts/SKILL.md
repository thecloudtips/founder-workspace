...
```bash
node ../../../scripts/late-tool.mjs accounts connect \
...
```bash
node ../../../scripts/late-tool.mjs accounts health --account-id=acc_123
```
...
node ../../../scripts/late-tool.mjs profiles list

# Create profile
node ../../../scripts/late-tool.mjs profiles create --name="My Brand"
```

## Disconnect

```bash
node ../../../scripts/late-tool.mjs accounts disconnect --account-id=acc_123
```
