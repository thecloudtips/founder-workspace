...
description: Adaptive task routing that uses accumulated patterns and context to make cross-plugin routing decisions and promote generalizable knowledge to the Memory Engine.
---
