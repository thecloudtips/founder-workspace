...
description: "Scans Founder OS plugin deployment, scores coverage by business area, and produces an actionable automation scorecard. Used by /founder-os:audit:scan and /founder-os:audit:report commands."
---
...
Scheduled Plugins: [N]/[installed] (see /founder-os:audit:report for details)
```
