...
description: "Detects usage patterns and auto-promotes memories after plugin execution. Use this skill as the final step of every plugin command, after primary output has been delivered, to log observations and promote patterns when confidence thresholds are met. Never blocks plugin output — all failures are silent."
---
