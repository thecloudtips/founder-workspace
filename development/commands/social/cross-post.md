...
5. Read `${CLAUDE_PLUGIN_ROOT}/_infrastructure/humanize-content/SKILL.md`
6. Read `${CLAUDE_PLUGIN_ROOT}/_infrastructure/humanize-content/references/social-humanization.md`
7. If media present: Read `${CLAUDE_PLUGIN_ROOT}/_infrastructure/late-skills/late-media/SKILL.md`
